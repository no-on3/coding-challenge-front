...
export const actions: ActionTree<RootState, RootState> = {
    ...
    const products = [
      {
        ...
        price: 35.73,
        description:
          'Consequatur non asperiores quisquam atque ipsam accusantium. Est repellendus eius voluptates sapiente in. Cum quam voluptatum recusandae ullam. Et provident dolorum delectus commodi.',
        available: 1,
        category: {
          id: 1,
          name: 'Home',
      ...
      },
      {
        ...
        price: 91.31,
        description:
          'Dolorem eveniet labore aliquam distinctio. Ea esse voluptas quas. Aut soluta autem unde hic nam. Deserunt eveniet sed autem voluptas amet asperiores vero. Sunt suscipit eaque quidem.',
        available: 1,
        category: {
          id: 2,
          name: 'Pet supplies',
      ...
      },
      {
        ...
        price: 58.37,
        description:
          'Impedit a est sint enim atque saepe quos. Omnis et possimus itaque quasi libero voluptas sequi. Iusto similique porro non quo temporibus molestias dolores sed. Et rerum aperiam similique esse impedit dolorem eum.',
        available: 0,
        category: {
          id: 3,
          name: 'Sports',
  ...
  setFilter({ commit, rootState }, payload) {

    console.log({root : rootState})
    const filters = { ...rootState.filters, ...payload }
